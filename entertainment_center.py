# To handle French accents this file uses the following encoding: utf-8
import media
import gmoat


# Add movies instances here
man_bites_dog = media.Movie(
	"C'est arrivé près de chez vous",
    "A crew of filmmakers follows a serial killer.",
    "https://upload.wikimedia.org/"
        "wikipedia/en/b/ba/Man_Bites_Dog_-_censored_poster.jpg",
...
dark_star = media.Movie(
	...
	"A satiric look at the problems experienced by a crew of bumbling "
	    "astronauts on a mission to destroy rogue planets.",
...
alien = media.Movie(
	"Alien",
	"A highly aggressive extraterrestrial creature stalks and attacks "
...
predator_2 = media.Movie(
	"Predator 2",
	"A predatory extraterrestrial creature in the middle of a drug cartel "
	    "turf war.",
...
lord_of_the_rings_1 = media.Movie(
	...
	"https://upload.wikimedia.org/wikipedia/en/9/9d/"
	    ...
	    "_%282001%29_theatrical_poster.jpg",
	"https://www.youtube.com/watch?v=V75dMMIW2B4",
	2001,
	"PG-13")
la_cite_de_la_peur = media.Movie(
	"La Cité de la peur",
	"A killer copies a movie villain's modus operandi at the Cannes Film "
	    "Festival, attended by the star, his publicist and an inept bodyguard.",
	"https://upload.wikimedia.org/wikipedia/en/a/ac/La_Cité_de_la_peur.jpg",
	"https://www.youtube.com/watch?v=CItygwB9mfY",
	1994,
	"Not rated")

movies = [lord_of_the_rings_1, man_bites_dog, dark_star, alien, predator_2, 
          la_cite_de_la_peur]

# Create the html file and open it in a browser
